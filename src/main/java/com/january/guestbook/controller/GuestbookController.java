...
public class GuestbookController {
    ...
    public void readPost(long gno,
        ...
        Guestbook guestbook = guestbookService.read(gno);
        model.addAttribute("dto", guestbook);
    }

    @PostMapping("/modify")
    public String modifyPost(Guestbook guestbook,
                             @ModelAttribute("requestDto") PageRequestDTO requestDTO,
                             RedirectAttributes redirectAttributes) {
        log.info("Modify post: {}", guestbook);
        ...
        // * 리다이렉트 후 URL: /guestbook/read?gno=123&page=1
        // * 브라우저 주소창에 보임
